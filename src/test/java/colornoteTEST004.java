...
public class colornoteTEST004 {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        //Edit Title
        driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/edit_title")).clear();
        driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/edit_title")).sendKeys("1st Note");
        System.out.println("STEP:-13 Edited a Title ");
        ...
        //Verify NEw title
        Thread.sleep(2000);
        String New_Note_title= driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/title")).getText();
        if (New_Note_title.equals("1st Note")) {
           System.out.println("New Note title is "+New_Note_title);
          } 
          System.out.println("STEP:-16 Verified New Title");
