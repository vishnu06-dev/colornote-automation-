...
public class colornoteTEST022 {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        //Default font size
        Thread.sleep(2000);
        WebElement Def_font_size=driver.findElement(By.xpath("//androidx.recyclerview.widget.RecyclerView[@resource-id=\"com.socialnmobile.dictapps.notepad.color.note:id/recycler_view\"]/android.widget.LinearLayout[7]"));
        Def_font_size.click();
        System.out.println("STEP:-6 default font size");

        //Change Default font size to Large
        WebElement Large= driver.findElement(By.xpath("//android.widget.CheckedTextView[@index='3']"));
        Large.click();
        Thread.sleep(3000);
        System.out.println("STEP:- change on default font size to large");
      
        driver.quit();
        System.out.println("SECNARIO END ");
    }
}