...
public class colornoteTEST014 {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
      ...
      System.out.println("STEP-3 Skip the tutorial of colornote opend home page");
        ...
        //CLick on more
        driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/menu_btn")).click();
        System.out.println("STEP:-19 tap on more option ");
        //Click on permenant delete
          Thread.sleep(1000);
        driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/text")).click();
        System.out.println("STEP:-20 clicked on permanent delete button ");

        //Click on ok
        driver.findElement(By.id("android:id/button1")).click();
        System.out.println("STEP:-21 Click on OK ");
        Thread.sleep(3000);
