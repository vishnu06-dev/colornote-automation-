...
public class colornoteTEST011 {
     public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Note_Text.sendKeys("hy Mob Team");
        ...
        //Verify Note Title
        if (Note_title_Text.equals("hy Mob Team")) {
        ...
        Reminder.click();
        System.out.println("STEP:-13 Tap on Reminder button ");
        ...
        Remind_aft_15.click();
          System.out.println("STEP:-14 Remind me after 15 min DONE");
       
        //Click on done
        WebElement Done =driver.findElement(By.id("com.socialnmobile.dictapps.notepad.color.note:id/button1"));
        Done.click();
        Thread.sleep(2000);
        System.out.println("STEP:-15 Tap on done button ");
